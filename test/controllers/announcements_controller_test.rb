...
class AnnouncementsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create announcement" do
    assert_difference("Announcement.count") do
      post announcements_url, params: { announcement: { content: @announcement.content, created_by: @announcement.created_by, posted_on: @announcement.posted_on, title: @announcement.title } }
    end
  ...
  test "should update announcement" do
    patch announcement_url(@announcement), params: { announcement: { content: @announcement.content, created_by: @announcement.created_by, posted_on: @announcement.posted_on, title: @announcement.title } }
